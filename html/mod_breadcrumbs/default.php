	...
	<ul itemscope itemtype="https://schema.org/BreadcrumbList" class="uk-breadcrumb">
		...
		foreach ($list as $key => $item) :
			if ($key !== $last_item_key) :
				...
				<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><?php echo $breadcrumbItem; ?>
			...
			<?php elseif ($show_last) :
				...
				<li aria-current="page" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span><?php echo $breadcrumbItem; ?>
					<meta itemprop="position" content="<?php echo $key + 1; ?>"></span>
				</li>
			<?php endif;
		endforeach; ?>
	</ul>
